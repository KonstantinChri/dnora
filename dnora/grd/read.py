...
class Xyz(TopoReader):
    """Reads data from an Xyz ascii file. Data can be in UTM or lon, lat

    Contributed by: https://github.com/emiliebyer
    """

    def __init__(self, expansion_factor: float=1.2, utmzone: int=None,
                 filename: str, folder: str='/lustre/storeB/project/fou/om/WW3/bathy/kartverket_50m_x_50m') -> Tuple:
        self.source=f'{folder}/{filename}'
        self.expansion_factor = expansion_factor
    ...
    def __str__(self):
        return(f"Reading xyz topography data from {self.source}.")

class KartverketNo50m(Xyz):
